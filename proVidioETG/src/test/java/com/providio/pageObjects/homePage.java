...
public class homePage extends baseClass{
 ...
 //mini cart
    ...
    List<WebElement> miniCartList =driver.findElements(By.xpath("//a[contains(@class, 'minicart')]"));
  ...
  ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);",WishList);
    ...
    public  void profile(WebDriver driver) throws InterruptedException {
    	 List<WebElement> profileList = driver.findElements(By.xpath("//span[contains(text(), 'Sign In')]"));	
